                  ...
                  <div className="space-y-3">
                    ...
                    >
                      {signingIn ? (
                        ...
                        /* Google G SVG — 2025 smooth gradient logo */
                        <svg className="w-5 h-5 flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <defs>
                            <linearGradient id="gSmoothGrad" x1="23" y1="1" x2="1" y2="23" gradientUnits="userSpaceOnUse">
                              <stop offset="0%"   stopColor="#EA4335"/>
                              <stop offset="32%"  stopColor="#FBBC05"/>
                              <stop offset="64%"  stopColor="#34A853"/>
                          ...
                          <rect x="0" y="0" width="24" height="24" fill="url(#gSmoothGrad)" clipPath="url(#gClip)"/>
                        </svg>
                      )}
