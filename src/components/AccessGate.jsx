    ...
    >
      ...
      <header className="fixed top-0 left-0 right-0 z-20 flex items-center justify-between px-6 py-6">
        <div className="flex items-center space-x-3">
          <div className={`flex items-center justify-center w-12 h-12 rounded-lg shadow-md ${darkMode ? 'bg-blue-600' : 'bg-red-600'}`}>
            <img
              src="airstream.png"
              className="h-8 w-8"
              alt="Airstream"
          ...
          <h1 className="text-2xl font-bold tracking-tight">
            <span className={darkMode ? 'text-blue-500' : 'text-red-600'}>
              AIRSTREAM
            </span>
          </h1>
        </div>
      ...
      {/* Main content */}
      <div className="relative z-10 w-full max-w-md lg:max-w-lg xl:max-w-xl mx-auto px-4 mt-24">
        {loading ? (
          ...
          <div className="flex flex-col items-center">
            <div className="w-full md:w-3/4 lg:w-full max-w-lg mx-auto">
              <div className={`rounded-xl shadow-xl overflow-hidden border ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-100'}`}>
                <div className={`h-2 ${darkMode ? 'bg-blue-600' : 'bg-red-600'}`}></div>
                
                <div className="p-8">
                  <div className="text-center mb-8">
                    <h2 className={`text-2xl font-bold ${darkMode ? 'text-blue-500' : 'text-red-600'} mb-2`}>
                      SECURE ACCESS
                    </h2>
                  ...
                  <form id="access-form" onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                            darkMode 
                              ...
                              : 'bg-gray-50 text-gray-900 border border-gray-200 focus:ring-red-500 focus:border-red-500'
                          }`}
                          autoComplete="off"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-10 py-3 rounded-lg focus:outline-none focus:ring-2 ${
                            darkMode 
                              ? 'bg-gray-700 text-white border border-gray-600 focus:ring-blue-500 focus:border-blue-500' 
                              : 'bg-gray-50 text-gray-900 border border-gray-200 focus:ring-red-500 focus:border-red-500'
                          }`}
                        ...
                        <button
                          ...
                          className={`absolute right-3 top-1/2 transform -translate-y-1/2 transition-colors ${darkMode ? 'text-gray-400 hover:text-blue-400' : 'text-gray-500 hover:text-red-500'}`}
                        >
                          {passwordVisible ? (
                    ...
                    {error && (
                      <div className={`p-4 rounded-lg flex items-center space-x-3 ${darkMode ? 'bg-red-900/30 text-red-300 border border-red-800/50' : 'bg-red-50 text-red-700 border border-red-200'}`}>
                    ...
                    <button
                      type="submit"
                      className={`w-full py-3 px-4 flex items-center justify-center text-white font-medium rounded-lg transition-colors duration-200 ${
                        darkMode 
                ...
                <div className={`p-4 ${darkMode ? 'bg-gray-900/50 border-t border-gray-700' : 'bg-gray-50 border-t border-gray-100'}`}>
                  <div className="flex items-center justify-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${darkMode ? 'text-blue-400' : 'text-red-500'}`} viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                    </svg>
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${darkMode ? 'text-blue-400' : 'text-red-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <span className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>256-bit Encryption</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 ${darkMode ? 'text-blue-400' : 'text-red-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>Secure Authentication</span>
                  </div>
                </div>
                <div>
                  <span className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>© {new Date().getFullYear()} Airstream</span>
                </div>
              </div>
            </div>
          </div>
