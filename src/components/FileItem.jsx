...
// MODIFICATION: Changed rounded-t-lg to rounded-t-xl to match parent FileItem's rounded-xl
containerBaseClasses += ' h-32 mb-2 rounded-t-xl'; // Larger size for grid view
}

if (type === 'image') {
return (
  <div className={containerBaseClasses}>
    <img src={thumbnailUrl} alt={`Preview of ${file.filename}`} className={imageVideoPreviewClasses} loading="lazy" />
...
return (
  <div className={containerBaseClasses}>
    <video src={`${thumbnailUrl}#t=0.5`} preload="metadata" className={`${imageVideoPreviewClasses} bg-black`} />
