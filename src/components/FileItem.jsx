               ...
               <div className="relative">
                  ...
                  {showMenu && (
                    <div
                      ref={menuRef}
                      className={cn(
                        `absolute right-0 mt-1 py-1 w-40 rounded-md shadow-xl z-50 border`, // Increased width slightly
                    ...
                    >
                      {/* Actions */}
                      <button onClick={download} className={cn('w-full text-left px-3.5 py-1.5 text-sm flex items-center gap-2.5 transition-colors', darkMode ? 'hover:bg-gray-700 text-white' : 'hover:bg-gray-100 text-gray-700')} role="menuitem">
                      ...
                      <button onClick={share} className={cn('w-full text-left px-3.5 py-1.5 text-sm flex items-center gap-2.5 transition-colors', darkMode ? 'hover:bg-gray-700 text-white' : 'hover:bg-gray-100 text-gray-700')} role="menuitem">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); setShowMenu(false); setShowDeleteConfirm(true); }} className={cn('w-full text-left px-3.5 py-1.5 text-sm flex items-center gap-2.5 transition-colors', darkMode ? 'hover:bg-red-900/40 text-red-400' : 'hover:bg-red-50 text-red-600')} role="menuitem">
