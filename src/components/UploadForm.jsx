         ...
         <ul className="space-y-2 max-h-60 overflow-y-auto pr-2"> {/* Added max-height and scroll */}
           {files.map((file, index) => (
             <li
               ...
               className={cn('flex justify-between items-center p-3 rounded-md shadow-sm', darkMode ? 'bg-gray-700 text-gray-200' : 'bg-gray-100 text-gray-700')}
             >
               ...
               <button
                 ...
                 className={cn(
                   "ml-4 p-1.5 rounded-full transition-colors",
