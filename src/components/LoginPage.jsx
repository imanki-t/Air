...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  "don't mine straight down... unless you're brave",
    ...
    "Reality
  can be disappointing, Minecraft never is",
    ...
    "The grass
  is always greener on my Minecraft server",
    ...
    "Built a castle for fun.
  Now I defend it like my GPA",
  ...
  "I survived Natural Disaster Survival and all I got was this badge",
    ...
    "I
  got scammed and it built character",
    "Adopt Me?
  More like Rob Me",
  ...
  I conquered the End",
    ...
    "Myth: Steve can’t feel pain.
  Truth: He just doesn’t show it",
    ...
    "Built a monument to my lost dog.
  Still cry at night",
    "No gods, only Notch",
    ...
    "The cake is a lie… but I still bake
  it",
    ...
    "I fear
  no man, but baby zombies terrify me",
    "I built a secret base under my friend’s base.
  ...
  setPhaseOpacity(step / fadeInSteps);
          ...
          const fadeOutTimer = setTimeout(() => {
              ...
              const fadeOutInterval = 300 /
  fadeOutSteps; // 300ms fade-out
  ...
  1.135 5.824 3 7.938l3-2.647z"></path></svg>
                         ...
                         {loading ?
  'Logging In...' : 'Login'} {/* Button text changes */}
                      </span>
                    </button>
                   </form>
                   {/* Link to Signup Page */}
      ...
      <div className="fixed bottom-4 left-6 text-gray-500 text-sm hidden md:flex flex-col items-start">
        <div className="flex items-center space-x-1 mb-1">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2
  4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
  ...
  strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
      ...
      <div className="hidden md:block fixed bottom-4 right-6 text-gray-500 text-sm max-w-xs text-right">
        <span>©
  {new Date().getFullYear()} Kuwuten • All Rights Reserved</span><br/>
      ...
      <div className="fixed bottom-10 left-10 w-16 h-16 opacity-10 hidden
  lg:block">
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
