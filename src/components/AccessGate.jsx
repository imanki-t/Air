...
const AccessGate = ({ children }) => {
      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-4 mt-24 sm:mt-28">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-8">
            <div className="relative w-28 h-28 md:w-40 md:h-40 mb-6">
              <div className="absolute inset-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-gray-300 text-sm md:text-xl animate-fadeInOut">
                  {phases[currentPhase]}
                </span>
              </div>
            </div>
  ...
  <span>Timeless Protection</span>
      ...
      <div className="hidden md:block fixed bottom-16 right-6 text-gray-500 text-sm max-w-xs text-right">
