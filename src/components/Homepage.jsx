...
const Homepage = ({ isLoggedIn }) => {
  ...
  return (
    <div className={`min-h-screen relative overflow-hidden font-inter transition-colors duration-500 ${darkMode ? 'bg-gray-950 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <nav className="relative z-10 px-6 py-6 mx-auto max-w-7xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            {/* Logo */}
            <div className={`w-10 h-10 rounded-lg ${darkMode ? 'bg-primaryBlue' : 'bg-primaryRed'} flex items-center justify-center text-white font-bold text-lg`}>
              K
            </div>
          ...
          <Link to={isLoggedIn ? "/dashboard" : "/login"}>
            <button className={`px-5 py-2.5 rounded-md font-medium transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
              darkMode 
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-8 mt-12 md:grid-cols-3">
            ...
            <div className={`p-6 rounded-xl transition-all duration-300 transform hover:scale-105 ${
              ...
              <div className="w-full h-40 mt-4 rounded-md bg-gray-200 flex items-center justify-center">
                <span className="text-gray-500 text-sm">feature1.jpg</span>
              </div>
            </div>
            ...
            <div className={`p-6 rounded-xl transition-all duration-300 transform hover:scale-105 ${
              ...
              <div className="w-full h-40 mt-4 rounded-md bg-gray-200 flex items-center justify-center">
                <span className="text-gray-500 text-sm">feature2.jpg</span>
              </div>
            </div>
            ...
            <div className={`p-6 rounded-xl transition-all duration-300 transform hover:scale-105 ${
              ...
              <div className="w-full h-40 mt-4 rounded-md bg-gray-200 flex items-center justify-center">
                <span className="text-gray-500 text-sm">feature3.jpg</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`relative z-10 w-full h-24 overflow-hidden ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <svg className="absolute w-full min-w-[1000px] h-24 transform rotate-180" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path 
            d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" 
            className={`${darkMode ? 'fill-gray-950' : 'fill-white'}`}
          ></path>
        </svg>
      </div>
      ...
      <footer className={`relative z-10 px-6 py-10 border-t ${
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-center justify-between md:flex-row">
            <div className="flex items-center space-x-2">
              <div className={`w-8 h-8 rounded-lg ${darkMode ? 'bg-primaryBlue' : 'bg-primaryRed'} flex items-center justify-center text-white font-bold text-sm`}>
                K
              </div>
